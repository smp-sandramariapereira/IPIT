...
- responsável por decisões técnicas e éticas;
...
- laboratórios de inovação e cultura maker;
...
4. **Tecnologia** — selecionar ferramentas, integrações e recursos técnicos.
5. **MVP** — definir o menor produto capaz de demonstrar valor.
6. **Arquitetura** — planejar componentes, dados, tarefas e organização do repositório.
...
As etapas podem ser realizadas em oito dias, oito encontros ou distribuídas ao longo de um bimestre ou trimestre. O formato deve ser ajustado aos objetivos curriculares, ao perfil dos estudantes e às condições da instituição.
...
- uso ético, seguro e responsável das tecnologias;
...
A experiência resultou em oito soluções tecnológicas voltadas a desafios educacionais, sociais, culturais e comunitários. Entre os resultados observados estiveram maior participação, ampliação da autonomia, fortalecimento da colaboração, integração entre componentes curriculares, melhoria da comunicação e desenvolvimento de competências relacionadas ao GitHub, à documentação técnica e às metodologias ágeis.

Esses resultados correspondem a uma experiência situada e não devem ser interpretados como garantia automática de desempenho em outros contextos. Cada aplicação precisa ser planejada, acompanhada e avaliada conforme sua realidade.
...
- uma metodologia dependente de Web3 ou Blockchain;
...
- adotar critérios de segurança, privacidade e acessibilidade;
- escolher tecnologias com base nas necessidades do projeto;
